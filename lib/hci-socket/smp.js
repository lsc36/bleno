...
var Smp = function(aclStream, localAddressType, localAddress, remoteAddressType, remoteAddress) {
  ...
  this.onAclStreamSetOobTkBinded = this.onAclStreamSetOobTk.bind(this);
  ...
  this._aclStream.on('setOobTk', this.onAclStreamSetOobTkBinded);
};
...
Smp.prototype.onAclStreamSetOobTk = function(oobTk) {
  this._tk = Buffer.from(oobTk);
  this._isOob = true;
};
...
Smp.prototype.handlePairingRequest = function(data) {
  ...
  var oobData = this._isOob ? 0x01 : 0x00;
  var authReq = this._isOob ? 0x05 : 0x01;
