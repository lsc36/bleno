...
BlenoBindings.prototype.setTk = function(tk) {
  if (this._aclStream) {
    this._aclStream.setTk(tk);
  }
};

BlenoBindings.prototype.setPairingFeature = function(ioCap, isOob, authReq) {
  if (this._aclStream) {
    this._aclStream.setPairingFeature(ioCap, isOob, authReq);
  }
};
