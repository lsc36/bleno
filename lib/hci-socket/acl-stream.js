...
AclStream.prototype.setTk = function(tk) {
  this.emit('setTk', tk);
};

AclStream.prototype.setPairingFeature = function(ioCap, isOob, authReq) {
  this.emit('setPairingFeature', ioCap, isOob, authReq);
};
